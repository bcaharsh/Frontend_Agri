  ...
  render()
   {
    const MyComponent = () => {
      return <div>
        <Navigationbar loginhandler={this.loginhandler} loginchange={this.loginchange} submithandler={this.submithandler} login={this.state.login} />
      </div>;
    };
    let mapsty = {
      width: '100%',
      ...
      <BrowserRouter>
        <div className="App">
          <Routes>
            ...
            {
              this.state.login ? (<Route path='/fertilizer' element={
                <div className='main-layout inner_page about_page'>
                  <MyComponent />
                  <h2 className='m-3'>FERTILIZER</h2>
                  <FertilizerContent product={this.state.product} addToCart={this.addToCart} />
                </div>
              } />) : (<Route path='/' element={
                <div className='main-layout inner_page about_page'>
                  <MyComponent />
